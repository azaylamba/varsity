...
You have to design & build the backend for the application and the ability for the users to register, add and read the articles.
...
https://github.com/azaylamba/varsity 
